...
analogWrite(enB, Speed); // Write The Duty Cycle 0 to 255 Enable Pin B for Motor2 Speed 
     ...
     if(bt_data == 1){front(); }  // if the bt_data is '1' the DC motor will go forward
else if(bt_data == 2){back();}  // if the bt_data is '2' the motor will Reverse
else if(bt_data == 3){left();}  // if the bt_data is '3' the motor will turn left
else if(bt_data == 4){right();} // if the bt_data is '4' the motor will turn right
else if(bt_data == 5){Stop(); }     // if the bt_data '5' the motor will Stop

else if(bt_data == 6){left();  delay(400);  bt_data = 5;}
else if(bt_data == 7){right(); delay(400);  bt_data = 5;}   
...
void left(){
Serial.println("forward");  //forword
...
void right(){
Serial.println("backword");  //backword
